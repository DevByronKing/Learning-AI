    ...
    <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-indigo-500/40 glow-brand animate-fadeIn mt-6">
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {!isCorrect && (
            <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-500/30">
              ...
              <p className="text-sm font-bold text-white mt-1">{errorLabel}</p>
              <p className="text-xs text-rose-200 mt-0.5">{errorDesc}</p>
              
              {selectedOption?.distractorReason && (
                <div className="mt-3 p-3 rounded-xl bg-dark-bg/60 border border-rose-500/20 text-xs text-slate-200">
          ...
          <div className="p-4 rounded-2xl bg-dark-surface/90 border border-white/5">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-dark-card/90 border border-white/10">
