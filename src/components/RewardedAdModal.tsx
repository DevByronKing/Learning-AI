...
export const RewardedAdModal: React.FC<RewardedAdModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="w-full max-w-lg glass-panel p-6 rounded-3xl border border-blue-500/40 relative glow-brand shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="my-5 rounded-2xl bg-gradient-to-br from-slate-900 via-[#0d1322] to-blue-950 p-6 border border-white/10 relative overflow-hidden flex flex-col items-center text-center">
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-blue-600/25 mb-3 animate-pulse-slow">
              ...
              {adStage === 'playing' ? (
                <div className="space-y-2">
                  ...
                  <div className="w-full h-2.5 rounded-full bg-slate-800 overflow-hidden border border-white/10">
                    <div 
                      className="h-full bg-gradient-to-r from-blue-600 via-cyan-500 to-emerald-400 transition-all duration-1000 ease-linear rounded-full"
