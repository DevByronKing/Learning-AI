    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-6 border-b border-slate-300 dark:border-white/10">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white dark:bg-dark-surface hover:bg-slate-50 dark:hover:bg-dark-hover border border-indigo-500/40 text-indigo-300 hover:text-slate-900 dark:text-white font-bold text-xs transition-all shadow-md"
          >
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-slate-300 dark:border-white/10 lg:col-span-2">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between text-xs text-slate-500 dark:text-slate-400">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${
                  currentWeek === week 
                    ...
                    : 'bg-white dark:bg-dark-surface text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white border border-slate-200 dark:border-white/5'
                }`}
              >
                Semana {week}
              </button>
            ...
            <div key={day.id} className="glass-panel rounded-3xl border border-slate-300 dark:border-white/10 p-5 flex flex-col justify-between">
              ...
              <div>
                <div className="flex items-center justify-between pb-3 border-b border-slate-300 dark:border-white/10 mb-4">
                  <div>
                    <h4 className="text-sm font-black text-slate-900 dark:text-white">{day.dayOfWeek}</h4>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">{day.dateStr}</p>
                  </div>
                ...
                <div className="space-y-3">
                  {day.blocks.map((block) => (
                    ...
                    >
                        ...
                        <button
                          ...
                          className={`w-6 h-6 rounded-lg flex items-center justify-center shrink-0 transition-colors ${
                            block.status === 'concluido'
                              ...
                              : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700'
                          }`}
                        >
                      ...
                      <div className="mt-3 pt-2 border-t border-slate-200 dark:border-white/5 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
              ...
              <div className="mt-4 pt-3 border-t border-slate-200 dark:border-white/5 text-center">
                <button
                  onClick={() => onGoToSimulator()}
                  className="w-full py-2 rounded-xl bg-white dark:bg-dark-card hover:bg-slate-50 dark:hover:bg-dark-hover border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 text-xs font-semibold flex items-center justify-center gap-1 transition-colors"
                >
